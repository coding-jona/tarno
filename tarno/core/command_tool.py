...
from tarno.core.action_logger import get_action_logger
...
from tarno.core.workspace import get_workspace_roots
...
class CommandTool:
    ...
    def close_window_gated(self, title_substring: str, user_query: str = "") -> ActionResult:
        ...
        """
        from tarno.desktop.window_manager import close_window
