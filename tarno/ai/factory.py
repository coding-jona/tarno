...
from tarno.ai.openai_compatible import OpenAICompatibleProvider
from tarno.ai.provider import RateLimiter
...
def _build_single_provider(
    ...
    if name == "claude":
        ...
        from tarno.ai.claude_client import ClaudeProvider
    ...
    if name == "ollama":
        from tarno.ai.ollama_client import OllamaProvider
    ...
    if name == "groq":
        from tarno.ai.groq_client import GroqProvider
    ...
    if name == "huggingface":
        from tarno.ai.huggingface_client import HuggingFaceProvider
