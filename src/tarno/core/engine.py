...
from tarno.ai.context.output_compressor import compress_tool_output_detailed
...
from tarno.ai.factory import create_provider_with_fallback as _create_provider
from tarno.ai.coding.agent import CodingAgent
from tarno.ai.coding.tool import build_coding_task_tool
...
from tarno.ai.prompts.code_system import CONTINUE_REMINDER
from tarno.ai.prompts.proactive_system import PROACTIVE_SYSTEM_PROMPT
from tarno.ai.tool_registry import ToolDefinition, ToolRegistry
from tarno.plugins.manager import PluginManager
from tarno.browser.browser_automation import (
    browser_click,
    browser_close,
    browser_navigate,
    browser_read,
...
from tarno.browser.web_control import fetch_webpage, open_browser, web_search
...
from tarno.core.command_tool import CommandTool
...
from tarno.integrations.mesh.observer import CloudMeshObserver, MeshObserver
from tarno.memory.fact_extractor import FactExtractor
from tarno.memory.knowledge_base import KnowledgeBase
...
from tarno.desktop.window_manager import close_window, focus_window
from tarno.extensions.coordinator import ExtensionCoordinator
from tarno.security.audit import AuditManager
from tarno.ui.console import ConsoleUI
...
class TarnoEngine:
    ...
    def _build_vision_observer(self, force: bool = False) -> "VisionObserver | None":
        ...
        *force* bypasses the config.vision.enabled check - used by
        ...
        from tarno.vision.vision_observer import VisionObserver
        from tarno.vision.vision_provider import MistralVisionProvider
    ...
    def set_provider(self, provider_name: str, model: str | None = None) -> tuple[bool, str]:
        ...
        from tarno.ai.factory import create_provider, provider_has_api_key
        from tarno.security.secrets import SecretsVault
    ...
    def run(self) -> None:
        ...
        from tarno.voice.recognizer import SpeechRecognizer
