...
import tarno.grpc.tarno_pb2 as _tarno_pb2
sys.modules["tarno_pb2"] = _tarno_pb2

from tarno.grpc.tarno_pb2 import (
    AutonomyModeUpdate,
    ChatInput,
    ChatMessage,
    ClientMessage,
...
from tarno.grpc.tarno_pb2_grpc import TarnoServicer, TarnoStub, add_TarnoServicer_to_server
