...
def main() -> None:
    ...
    if "--first-start" in sys.argv:
        from tarno_backend.first_start import run_first_start
    ...
    if "--backend" in sys.argv:
        ...
        import asyncio
        from tarno_backend.grpc.server import run_grpc_server
        ...
        from tarno_backend.ui.app import run_ui
        run_ui(config)
    else:
        from tarno_backend.ui.winui_launcher import launch_winui
